...
const KAKAO_REDIRECT_URI = `${process.env.REACT_APP_MOVIE_MANG_FRONT_URL}/oauth/kakao`;
...
const NAVER_REDIRECT_URI = `${process.env.REACT_APP_MOVIE_MANG_FRONT_URL}/oauth/naver`;
